...
### Prompt 3 — Build the MCP server with all 4 tools
...
### Prompt 6 — Wire up the FastAPI backend
...
## Phase 4 — Frontend (vibe code this entirely)

### Prompt 7 — Vibe-code the full frontend
...
### Prompt 8 — Write the Dockerfiles
...
### Prompt 9 — Deploy via AntiGravity MCP (paste this into AntiGravity)
...
### Prompt 10 — Verify the deployment
...
## Optional: Add Memory Bank (bonus wow factor)

### Prompt 11 — Hook up Vertex AI Memory Bank
